...
def getargs():
    parser = OptionParser(prog='Enum Whois', description='Enumeration on Whois', epilog='Developed by NURUDEEN OLUWASEUN ADEBILEJE (EXPLORER)')
    parser.add_option('-d', '--domain', default='localhost', help='get your target domain')
...
def check_domain(url):
    try:
        ...
        print(colored("[-] ", 'yellow') + colored("NewConnectionError", 'red') + colored(" Please add --help or -h"))
